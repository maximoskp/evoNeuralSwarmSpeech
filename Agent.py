...
class GenericAgent:
    category = 'generic'
    def __init__(self, genome=None, constants=None):
        # External input:
        # 1. Number of friends.
        ...
        self.init_random()
        print('self.velocity_limit:', self.constants.agent_constants[self.category]['velocity_limit'])
    # end __init__
    ...
    def random_genome(self):
        ...
        self.genome = np.random.random( self.genome_size )
    # end random_genome
    ...
    def perceive(self, environment):
        print('environment comes in as an object')
        # for testing, if environment is None, random values apply
        if environment is None:
            print('random environment')
    # end perceive

    def act(self, environment=None, constants=None):
